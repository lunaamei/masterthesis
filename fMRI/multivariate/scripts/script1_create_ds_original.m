...
%% ROI suffixes
roi_suffixes = {'_LOTC_body_left', '_LOTC_hand_left', '_LOTC_tool_left', '_LOTC_body_right', '_LOTC_hand_right'};

%% Paths
base_study_path = ['/Users/lunameidoering/Uni/MASTER/Erasmus/MASTERTHESIS/fMRI/multivariate/fMRI_new/fMRI_preprocessed/sub12/original/' ...
    ''];
base_mask_path = '/Users/lunameidoering/Uni/MASTER/Erasmus/MASTERTHESIS/fMRI/multivariate/fMRI_new/rois/';
base_results_path = '/Users/lunameidoering/Uni/MASTER/Erasmus/MASTERTHESIS/fMRI/multivariate/fMRI_new/ds_original';
